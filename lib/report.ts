// lib/report.ts — NEXUS AI Report System (TypeScript v2)
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%"
      ...
      <tr>
        <td style="padding:10px 20px;font-family:${FONT_MONO};font-size:10px;
                   color:#3a5a7a;width:110px;border-bottom:1px solid #0a1e2a;">PACKAGE</td>
      ...
      <tr>
        <td style="padding:10px 20px;font-family:${FONT_MONO};font-size:10px;
                   color:#3a5a7a;border-bottom:1px solid #0a1e2a;">TXN ID</td>
        ...
        <tr>
          <td colspan="3" align="center" style="padding:28px 28px 8px;">
            <p style="margin:0 0 4px;font-family:${FONT_MONO};font-size:10px;font-weight:700;
              ...
              ◆ NEXUS STUDIO ◆</p>
            <p style="margin:0;font-family:${FONT_MONO};font-size:30px;font-weight:900;
                      letter-spacing:5px;color:#00c8e0;">NEXUS AI</p>
          </td>
        </tr>
        <tr>
          <td colspan="3" align="center" style="padding:0 28px 26px;">
            <table cellpadding="0" cellspacing="0" border="0" align="center"><tr>
              <td style="background-color:${isPayment ? '#003820' : '#001830'};
                ...
                ${isPayment ? '💳 NEW PAYMENT' : '📩 NEW REPORT'}</td>
            </tr></table>
          </td>
        </tr>
      </table>
          ...
          <td align="center" style="padding:24px 20px 22px;">
            ...
            <table cellpadding="0" cellspacing="0" border="0" align="center"><tr>
              <td style="background-color:#1e1400;color:#d4a017;border:1px solid #3a2a00;
                         border-radius:20px;padding:4px 14px;font-family:${FONT_MONO};
      ...
      <table cellpadding="0" cellspacing="0" border="0" width="100%"
        ...
        <tr>
          ...
          <td style="padding:18px 18px 18px 16px;">
            <p style="margin:0 0 12px;font-family:${FONT_MONO};font-size:9px;font-weight:700;
      ...
      <tr>
        ...
        <td style="padding:14px 16px;">
          <p style="margin:0 0 6px;font-family:${FONT_MONO};font-size:9px;
            ...
            📝 Admin Note</p>
          <p style="margin:0;font-family:${FONT_SANS};font-size:12px;
                    color:#c0c0e0;line-height:1.7;">${esc(adminNote, 500)}</p>
        </td>
      </tr>
    </table>` : '';
  ...
  <table cellpadding="0" cellspacing="0" border="0" width="560"
        ...
        <tr>
          <td align="center" style="padding:28px 28px 24px;">
            ...
            <p style="margin:0 0 8px;font-family:${FONT_MONO};font-size:26px;
                      font-weight:900;letter-spacing:5px;color:#00c8e0;">NEXUS AI</p>
    ...
    <tr><td style="background-color:#07081e;border-left:1px solid #1a2a4a;
      ...
      <table cellpadding="0" cellspacing="0" border="0" width="100%"
        ...
        <tr>
          <td style="padding:11px 16px;font-family:${FONT_SANS};font-size:11px;
                     color:#3a5a7a;">Status</td>
          <td style="padding:11px 0;font-family:${FONT_SANS};font-size:12px;font-weight:700;
...
const handler: HandlerFn = async (req: AdaptedRequest, res: AdaptedResponse) => {
  ...
  if (req.method === 'POST') {
    ...
    sendEmail({
      ...
      if (!result.ok) console.warn('[report] Email failed:', result.reason ?? result.error);
    }).catch((e: unknown) =>
      console.error('[report] Email exception:', e instanceof Error ? e.message : e)
    );
