...
export default function NotFound() {
  ...
  // Generate floating particles (same as original JS)
  useEffect(() => {
    const container = particlesRef.current;
    if (!container) return;
    const colors = ['#00e5ff', '#8800ff', '#ff2d6b', '#00ffaa'];
    for (let i = 0; i < 28; i++) {
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { margin:0; padding:0; box-sizing:border-box; }
        ...
        .topbar {
          ...
          z-index:10; animation:slideDown .5s ease both;
        }
        @keyframes slideDown {
        ...
        .error-code {
          ...
          font-weight:900; line-height:1; position:relative;
          color:transparent; -webkit-text-stroke:1px rgba(0,229,255,.15);
          margin-bottom:4px;
        }
        ...
        .terminal {
          ...
          overflow:hidden; max-width:500px; width:100%; margin-bottom:24px;
        ...
        .t-prompt-err { color:var(--pink); flex-shrink:0; }
        .t-prompt-ok  { color:var(--green); flex-shrink:0; }
        .t-prompt-warn{ color:var(--yellow); flex-shrink:0; }
        ...
        .cursor {
          ...
          background:var(--cyan); border-radius:1px; margin-left:3px;
          vertical-align:middle; opacity:0;
          animation:blink .8s step-end infinite 2.2s forwards;
        }
        ...
        .btn {
          ...
          letter-spacing:1px; cursor:pointer; border:none; text-decoration:none;
        ...
        @media (max-width:500px) {
          ...
          .terminal   { max-width:95vw; }
          .actions    { flex-direction:column; align-items:center; }
          .btn        { width:200px; justify-content:center; }
          .footer     { font-size:8px; gap:10px; }
        }
      `}</style>
      ...
      <div className="topbar">
        <div className="topbar-logo">
          <img src="/nexusai.png" alt="N" onError={(e) => { (e.target as HTMLImageElement).style.display = 'none'; }} />
        </div>
        <div className="topbar-name">NEXUS AI</div>
        <div className="topbar-sep">/</div>
        <div className="topbar-sub">Roblox Dev Intelligence</div>
        <div className="topbar-right">
          <div className="topbar-dot" />
          <div className="topbar-status">Page Error</div>
        </div>
      </div>
        ...
        <div className="main">
          ...
          <div className="terminal">
            <div className="terminal-hdr">
              ...
              <div className="terminal-path">nexusai-roblox.vercel.app/~</div>
            </div>
            <div className="terminal-body">
              <div className="t-line">
                <span className="t-prompt">$</span>
                <span className="t-text">
                  nexus scan <span className="t-hl">--path</span>{' '}
                  <span className="t-warn">&quot;{pathname ?? '/???'}&quot;</span>
                </span>
              </div>
              <div className="t-line">
                <span className="t-prompt-err">✗</span>
                <span className="t-text">
                  <span className="t-err">ERROR</span>{' '}
                  <span className="t-dim">Route not found in workspace</span>
                </span>
              </div>
              <div className="t-line">
                <span className="t-prompt-warn">!</span>
                <span className="t-text">
                  <span className="t-warn">WARN</span>{' '}
                  <span className="t-dim">Instance does not exist in ServerStorage</span>
                </span>
              </div>
              <div className="t-line">
                <span className="t-prompt-ok">→</span>
                <span className="t-text">
                  <span className="t-dim">Suggest:</span>{' '}
                  <span className="t-ok">redirect to /dashboard</span>
                </span>
              </div>
              <div className="t-line">
                <span className="t-prompt">_</span>
                <span className="t-text">
                  <span className="t-dim">Waiting for input...</span>
          ...
          <div className="actions">
            ...
            <Link href="/chats" className="btn btn-secondary">
              <svg viewBox="0 0 24 24">
      ...
      <div className="footer">
        ...
        YouTube: <span className="footer-accent">NEXUS STUDIO</span>
        <span className="footer-sep">|</span>
        <span className="footer-dim">v10.6</span>
      </div>
    </>
  );
}