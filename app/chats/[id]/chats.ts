...
function mkAv(role: string): HTMLElement {
  ...
  if (role === 'ai') {
    const img = document.createElement('img'); img.src = '/nexusai.png'; img.alt = 'N'
    img.onerror = () => {
...
function openAvatarModal(): void {
  ...
  if (imgEl) { imgEl.src = u.avatar || '/nexusai.png'; imgEl.onerror = () => { imgEl.src = '/nexusai.png' } }
...
async function initApp(): Promise<void> {
  ...
  if (av) { av.src = u.avatar || '/nexusai.png'; av.onerror = () => { try { av.src = '/nexusai.png' } catch { } } }
