...
/* ─────────────────────────────────────────────────────────────────────────────
   CSS — NEXUS AI Chats Page
   zoom-safe · flex min-height · responsive · complete
───────────────────────────────────────────────────────────────────────────── */
const PAGE_CSS = `
:root{
  ...
  --r:8px;--btn-h:32px;--btn-sm:28px;--sb-w:255px;
}

*,*::before,*::after{margin:0;padding:0;box-sizing:border-box}

html{height:100%;font-family:'JetBrains Mono',monospace;background:var(--bg);color:var(--text);font-size:13px;overflow:hidden}
body{height:100%;overflow:hidden;min-height:0}

body::before{
  content:'';position:fixed;inset:0;
  background:linear-gradient(rgba(0,229,255,.012) 1px,transparent 1px),linear-gradient(90deg,rgba(0,229,255,.012) 1px,transparent 1px);
...
#app{
  ...
  position:relative;z-index:1;transition:grid-template-columns .2s;overflow:hidden;
}
...
.btn-nc,.help-btn,.inbox-btn{
  display:flex;align-items:center;gap:7px;width:100%;height:var(--btn-h);padding:0 11px;border-radius:var(--r);
...
.convs{flex:1;overflow-y:auto;padding:3px 7px;min-height:0}
...
.collapse-sb{
  ...
  width:18px;height:40px;background:var(--bg2);border:1px solid var(--b);border-left:none;border-radius:0 6px 6px 0;
  cursor:pointer;display:flex;align-items:center;justify-content:center;color:var(--dim);z-index:10;transition:color .15s;
}
...
.chat-hdr{padding:9px 16px;border-bottom:1px solid var(--b);background:var(--bg2);display:flex;align-items:center;gap:9px;flex-shrink:0;min-width:0}
...
.chat-tabs{display:flex;gap:4px;padding:5px 14px;border-bottom:1px solid var(--b);background:var(--bg2);flex-shrink:0;align-items:center;overflow-x:auto;overflow-y:hidden;scrollbar-width:none}
...
/* ── INPUT AREA ── */
.inp-area{padding:9px 14px;border-top:1px solid var(--b);background:var(--bg2);flex-shrink:0;position:relative;z-index:2}
...
.inp-bar{display:flex;align-items:center;height:44px;padding:0 9px;border-top:1px solid var(--b);gap:4px;flex-wrap:nowrap;overflow:hidden}
.inp-l{display:flex;align-items:center;gap:4px;flex:1;min-width:0;overflow:hidden;height:100%}
.ib{
  width:27px;height:27px;border-radius:5px;border:1px solid var(--b);background:transparent;color:var(--dim);cursor:pointer;
  display:inline-flex;align-items:center;justify-content:center;transition:.12s;flex-shrink:0;
  padding:0;margin:0;user-select:none;-webkit-user-select:none;vertical-align:middle;line-height:1;
  appearance:none;-webkit-appearance:none;outline:none;box-sizing:border-box;font-family:'JetBrains Mono',monospace;
}
...
.inp-model{
  ...
  cursor:pointer;transition:.12s;font-family:'JetBrains Mono',monospace;font-size:9px;color:var(--dim);
...
.studio-summary-title{color:var(--green);font-size:9px;font-weight:700;margin-bottom:4px;display:flex;align-items:center;gap:4px;flex-wrap:wrap}
.studio-summary-items{transition:all .15s ease}
...
.gui-toolbar{padding:6px 12px;border-bottom:1px solid var(--b);background:var(--bg2);display:flex;align-items:center;gap:4px;flex-wrap:wrap;flex-shrink:0;overflow-x:auto;overflow-y:hidden;scrollbar-width:none}
...
/* ── MODALS ── */
.ov{position:fixed;inset:0;background:rgba(3,3,18,.93);z-index:500;display:none;align-items:flex-start;justify-content:center;backdrop-filter:blur(5px);padding:20px 16px;overflow-y:auto}
.ov.show{display:flex}
.modal{background:var(--bg2);border:1px solid var(--b);border-radius:13px;padding:22px;width:500px;max-width:100%;box-shadow:0 24px 64px rgba(0,0,0,.9);overflow-y:visible;margin:auto;position:relative}
...
/* ── MENTION DROPDOWN ── */
.mention-dd{position:fixed;background:var(--bg3);border:1px solid var(--bb);border-radius:var(--r);z-index:8000;max-height:min(260px,50vh);overflow-y:auto;box-shadow:0 -10px 40px rgba(0,0,0,.97);min-width:290px;display:none}
        ...
        <div id="chat">
          ...
          >
            ...
            <div className="inp-area">
              ...
              {/* Dropdowns rendered inside inp-area for correct z-index stacking */}
        ...
        <div className="modal" style={{ width: 520 }}>
          ...
          <div className="settings-section">
            ...
            <div className="settings-row">
              ...
              <span id="settingsRobloxId" style={{ color: 'var(--dim)', fontSize: 10 }}>-</span>
            </div>
          </div>
