...
declare function showInstall(): void;
declare function retryStudio(): void;
declare function toggleMDD(e: React.MouseEvent): void;
declare function toggleThemeDD(e: React.MouseEvent): void;
declare function toggleGuiMDD(e: React.MouseEvent): void;
declare function handleFile(e: React.ChangeEvent<HTMLInputElement>): void;
declare function clearChat(): void;
declare function send(): void;
declare function cancelGen(): void;
declare function switchTab(tab: string): void;
declare function addEl(type: string): void;
declare function applyGuiTheme(val: string): void;
declare function openGuiAIChat(): void;
declare function clearCanvas(): void;
declare function generateGuiCode(): void;
declare function sendGuiToPlace(): void;
declare function closeModal(id: string): void;
declare function togglePlayTest(): void;
declare function setPlayTestDur(val: string): void;
declare function changeLang(val: string): void;
declare function claimDaily(): void;
declare function sendReport(): void;
declare function redeemCode(): void;
declare function logout(): void;
declare function copyGuiCode(): void;
declare function downloadGuiCode(): void;
declare function generateGuiFromAI(): void;
      ...
      <div id="app" className="hidden">
        ...
        <div id="chat">
          ...
          <div className="chat-hdr">
            ...
            <div className="status-badge off" id="studioBadge" onClick={() => retryStudio()}>
            ...
            <div className="gui-main">
              ...
              <div className="gui-canvas">
                ...
                <div className="gui-loading" id="guiLoading">
                  <div style={{ width: '20px', height: '20px', border: '2px solid rgba(0,229,255,.2)', borderTopColor: 'var(--cyan)', borderRadius: '50%', animation: 'spin .7s linear infinite' }} />
      ...
      <div className="ov" id="avatarModal">
        <div className="modal" style={{ width: '340px', textAlign: 'center', padding: '26px' }}>
          ...
          <div className="modal-footer" style={{ justifyContent: 'center', marginTop: '14px' }}>
            <button className="btn-modal primary" onClick={() => closeModal('avatarModal')} id="avatarCloseBtn">CLOSE</button>
          </div>
        </div>
      </div>
      ...
      <div className="ov" id="installModal">
        <div className="modal">
          ...
          <div className="modal-footer">
            <button className="btn-modal primary" onClick={() => closeModal('installModal')} id="installCloseBtn">GOT IT</button>
          </div>
        </div>
      </div>
        ...
        <div className="modal" style={{ width: '520px' }}>
          ...
          <div className="settings-section">
            ...
            <div className="settings-row">
              <span id="lastClaimInfo" style={{ fontSize: '10px', color: 'var(--dim)' }} />
              <button className="settings-btn" id="claimDailyBtn" onClick={() => claimDaily()}>Claim Daily</button>
            </div>
          </div>
          ...
          <div className="settings-section">
            ...
            <div className="settings-row">
              ...
              <select className="settings-select" id="langSelector" onChange={(e) => changeLang(e.currentTarget.value)}>
          ...
          <div className="settings-section">
            ...
            <div style={{ marginTop: '8px', display: 'flex', alignItems: 'center', gap: '8px' }}>
              <button className="settings-btn" onClick={() => sendReport()} id="reportBtn">Send Report</button>
              <span id="reportStatus" style={{ fontSize: '10px', color: 'var(--green)' }} />
            </div>
          </div>
          ...
          <div className="modal-footer">
            <button className="btn-modal primary" onClick={() => closeModal('settingsModal')} id="settingsCloseBtn">CLOSE</button>
          </div>
        </div>
      </div>
      ...
      <div className="ov" id="codePreviewModal">
        <div className="modal" style={{ width: '700px' }}>
          <div className="modal-t">
            ...
            <span style={{ marginLeft: 'auto', fontSize: '9px', color: 'var(--dim)' }} id="codePreviewPath" />
          </div>
            ...
            <div className="code-block-wrap" style={{ margin: 0, borderRadius: '7px', overflow: 'hidden', border: '1px solid rgba(0,229,255,.15)' }}>
              <div className="code-lang-bar">
                ...
                <div className="code-btns">
                  <button className="cbtn" onClick={() => copyPreviewCode()}>
              ...
              <pre style={{ maxHeight: '440px', overflowY: 'auto', margin: 0 }}>
                <code id="codePreviewCode" className="language-lua" style={{ fontSize: '11px', lineHeight: '1.5', padding: '14px', display: 'block' }} />
              </pre>
            </div>
          </div>
          <div className="modal-footer" style={{ marginTop: '12px' }}>
            <button className="btn-modal secondary" onClick={() => closeModal('codePreviewModal')} id="codePreviewCloseBtn">Close</button>
          </div>
        </div>
      </div>
