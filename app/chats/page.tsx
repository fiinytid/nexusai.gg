...
@media (max-width: 768px) {
  #app { display: flex !important; flex-direction: column; height: 100dvh; grid-template-columns: none !important; overflow: hidden; }
  #app.sb-hidden #sb { display: none; }
  #sb { width: 100%; border-right: none; border-bottom: 1px solid var(--b); flex-shrink: 0; }
  .convs, .sb-footer, .sec-lbl { display: none; }
  .creds { margin: 5px 10px; padding: 6px 10px; }
  .cred-v { font-size: 14px; }
  .sb-btn-group { flex-direction: row; overflow-x: auto; gap: 5px; padding: 5px 10px 6px; -webkit-overflow-scrolling: touch; scrollbar-width: none; }
...
export default function ChatsPage() {
  return (
    <>
      ...
      <Script src="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/languages/lua.min.js" strategy="afterInteractive" />
      <Script src="https://challenges.cloudflare.com/turnstile/v0/api.js?render=explicit" strategy="afterInteractive" />
      <Script src="/js/system_prompt.js" strategy="afterInteractive" />
      ...
      <div id="app" className="hidden">
        ...
        <div id="sb">
          ...
          <div className="sb-user">
            <img
              ...
              onClick={() => callGlobal('openAvatarModal')}
            />
            <div style={{ minWidth: 0, flex: 1 }}>
              <div className="sb-un" id="sbUn">-</div>
              <div className="sb-role" id="sbRole">Roblox Developer</div>
            </div>
            <button className="sb-gear" onClick={() => callGlobal('openSettings')} aria-label="Settings">
          ...
          <div className="sb-btn-group">
            ...
            <button className="btn-nc" onClick={() => callGlobal('newChat')}>
              <svg viewBox="0 0 24 24">
          ...
          <div
            ...
            onClick={() => callGlobal('toggleSidebar')}
            id="collapseSbBtn"
            role="button"
        ...
        <div id="chat">
          ...
          <div className="plug-banner" id="plugBanner">
            ...
            <a onClick={() => callGlobal('showInstall')} id="plugInstallLink">How to connect</a>
            <a
              onClick={() => callGlobal('retryStudio')}
              style={{ marginLeft: '8px', color: 'var(--green)' }}
          ...
          <div className="chat-hdr">
            ...
            <div className="proj-badge-hdr" id="hdrProjBadge" style={{ display: 'none' }}></div>
            <div className="status-badge off" id="studioBadge" onClick={() => callGlobal('retryStudio')}>
              <div className="sdot pulse" id="studioDot"></div>
          ...
          <div className="chat-tabs">
            <button
              ...
              id="tabChat"
              onClick={(e) => callGlobal('switchTab', 'chat', e.currentTarget)}
            >
              <svg viewBox="0 0 24 24">
            ...
            <button
              className="tab-btn"
              id="tabGui"
              onClick={(e) => callGlobal('switchTab', 'gui', e.currentTarget)}
            >
              <svg viewBox="0 0 24 24">
          ...
          <div id="chatTab" style={{ flex: 1, overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
            <div id="msgs">
              <div className="welcome" id="welcome">
                ...
                <div className="suggs" id="suggGrid"></div>
              </div>
            </div>

            <div className="inp-area" id="inpArea">
              <div className="attach-row" id="attachRow"></div>
              <div className="inp-box" id="inpBox">
                <textarea id="inp" placeholder="Ask NEXUS AI..." rows={1}></textarea>
                <div className="inp-bar">
                  <div className="inp-l">
                    ...
                    <input
                      ...
                      style={{ display: 'none' }}
                      onChange={(e) => callGlobal('handleFile', e)}
                      multiple
                    />

                    <button className="ib" onClick={() => callGlobal('clearChat')} title="Clear chat" aria-label="Clear chat">
                      <svg viewBox="0 0 24 24">
                    ...
                    <div
                      className="inp-model"
                      id="inpModelBtn"
                      onClick={(e) => callGlobal('toggleMDD', e)}
                      role="button"
                    ...
                    <button
                      ...
                      id="themePickerBtn"
                      onClick={(e) => callGlobal('toggleThemeDD', e)}
                      title="Select Theme"
                      aria-label="Select theme"
                    >
                      <div className="theme-swatch" id="themeSwatchBtn" style={{ background: '#00e5ff' }}></div>
                  ...
                  <button className="btn-cancel hidden" id="cancelBtn" onClick={() => callGlobal('cancelGen')} aria-label="Cancel">
                    <svg viewBox="0 0 24 24">
                      <line x1="18" y1="6" x2="6" y2="18" />
                      <line x1="6" y1="6" x2="18" y2="18" />
                    </svg>
                  </button>
                  <button className="btn-send" id="sendBtn" onClick={() => callGlobal('send')} aria-label="Send">
                    <svg viewBox="0 0 24 24">
              ...
              <div className="model-dd" id="mDD"></div>
              <div className="theme-dd" id="themeDD"></div>
            </div>
          </div>
          ...
          <div id="guiTab">
            <div className="gui-toolbar">
              ...
              <button className="gui-btn" onClick={() => callGlobal('addEl', 'Frame')}>
                <svg viewBox="0 0 24 24"><rect x="3" y="3" width="18" height="18" rx="2" /></svg>Frame
              </button>
              <button className="gui-btn" onClick={() => callGlobal('addEl', 'TextLabel')}>
                <svg viewBox="0 0 24 24"><polyline points="4 7 4 4 20 4 20 7" /><line x1="9" y1="20" x2="15" y2="20" /><line x1="12" y1="4" x2="12" y2="20" /></svg>Label
              </button>
              <button className="gui-btn" onClick={() => callGlobal('addEl', 'TextButton')}>
                <svg viewBox="0 0 24 24"><rect x="2" y="7" width="20" height="10" rx="3" /></svg>Button
              </button>
              <button className="gui-btn" onClick={() => callGlobal('addEl', 'TextBox')}>
                <svg viewBox="0 0 24 24"><rect x="3" y="5" width="18" height="14" rx="2" /><line x1="7" y1="12" x2="17" y2="12" /></svg>Input
              </button>
              <button className="gui-btn" onClick={() => callGlobal('addEl', 'ImageLabel')}>
                <svg viewBox="0 0 24 24"><rect x="3" y="3" width="18" height="18" rx="2" /><circle cx="8.5" cy="8.5" r="1.5" /><polyline points="21 15 16 10 5 21" /></svg>Image
              </button>
              <button className="gui-btn" onClick={() => callGlobal('addEl', 'ScrollingFrame')}>
                <svg viewBox="0 0 24 24"><rect x="3" y="3" width="18" height="18" rx="2" /><path d="M3 9h18" /></svg>Scroll
              </button>
              ...
              <div style={{ marginLeft: 'auto', display: 'flex', gap: '4px', alignItems: 'center', flexWrap: 'wrap' }}>
                <div
                  className="inp-model"
                  id="guiModelBtn"
                  onClick={(e) => callGlobal('toggleGuiMDD', e)}
                ...
                <div className="model-dd" id="guiMDD"></div>

                <select
                  id="guiThemeSelect"
                  className="settings-select"
                  style={{ fontSize: '9px', padding: '3px 6px', maxWidth: '110px' }}
                  onChange={(e) => callGlobal('applyGuiTheme', e.target.value)}
                >
                ...
                <button className="gui-ai-btn" onClick={() => callGlobal('openGuiAIChat')}>
                  <svg viewBox="0 0 24 24">
                ...
                <button className="gui-btn" onClick={() => callGlobal('clearCanvas')}>
                  <svg viewBox="0 0 24 24">
                    <polyline points="3 6 5 6 21 6" />
                    <path d="M19 6v14a2 2 0 01-2 2H7a2 2 0 01-2-2V6m3 0V4a2 2 0 012-2h4a2 2 0 012 2v2" />
                  </svg>
                ...
                <button className="gui-gen-btn" onClick={() => callGlobal('generateGuiCode')}>
                  <svg viewBox="0 0 24 24">
                ...
                <button
                  ...
                  onClick={() => callGlobal('sendGuiToPlace')}
            ...
            <div className="gui-main">
              ...
              <div className="gui-canvas">
                ...
                <div className="gui-loading" id="guiLoading">
                  <div style={{ width: '20px', height: '20px', border: '2px solid rgba(0,229,255,.2)', borderTopColor: 'var(--cyan)', borderRadius: '50%', animation: 'spin .7s linear infinite' }}></div>
                  <span id="guiLoadingText">AI is building UI...</span>
                </div>
              </div>

              <div className="gui-props" id="guiProps">
                <div style={{ fontSize: '10px', color: 'var(--dim)', textAlign: 'center', padding: '20px 0' }} id="guiPropsEmpty">Select element</div>
              </div>
            </div>
          </div>
      ...
      <div className="ov" id="avatarModal">
        <div className="modal" style={{ width: '340px', textAlign: 'center', padding: '26px' }}>
          ...
          <div className="modal-footer" style={{ justifyContent: 'center', marginTop: '14px' }}>
            <button className="btn-modal primary" onClick={() => callGlobal('closeModal', 'avatarModal')} id="avatarCloseBtn">CLOSE</button>
          </div>
        </div>
      </div>
      ...
      <div className="ov" id="installModal">
        <div className="modal">
          ...
          <div className="modal-footer">
            <button className="btn-modal primary" onClick={() => callGlobal('closeModal', 'installModal')} id="installCloseBtn">GOT IT</button>
          </div>
        </div>
      </div>
        ...
        <div className="modal" style={{ width: '520px' }}>
          ...
          <div className="settings-section">
            ...
            <div className="settings-row">
              ...
              <span id="settingsRobloxId" style={{ color: 'var(--dim)', fontSize: '10px' }}>-</span>
            </div>
          </div>
          ...
          <div className="settings-section">
            ...
            <div className="settings-row">
              <span id="lastClaimInfo" style={{ fontSize: '10px', color: 'var(--dim)' }}></span>
              <button className="settings-btn" id="claimDailyBtn" onClick={() => callGlobal('claimDaily')}>Claim Daily</button>
            </div>
          </div>
          ...
          <div className="settings-section">
            ...
            <div className="settings-row">
              ...
              <button className="toggle-sw on" id="playTestToggle" onClick={() => callGlobal('togglePlayTest')} aria-label="Toggle play test"></button>
            </div>
            <div className="settings-row">
              ...
              <input
                ...
                max={120}
                defaultValue={15}
                onChange={(e) => callGlobal('setPlayTestDur', e.target.value)}
              />
            </div>
          </div>
          ...
          <div className="settings-section">
            ...
            <div className="settings-row">
              ...
              <select className="settings-select" id="langSelector" onChange={(e) => callGlobal('changeLang', e.target.value)}>
          ...
          <div className="settings-section">
            ...
            <textarea className="report-ta" id="reportTa" placeholder="Describe the issue..."></textarea>
            <div id="cf-turnstile-wrap" style={{ marginTop: '8px', minHeight: '65px', display: 'none' }}>
              <div id="cf-turnstile-report" style={{ transform: 'scale(0.85)', transformOrigin: 'left' }}></div>
            </div>
            <div style={{ marginTop: '8px', display: 'flex', alignItems: 'center', gap: '8px' }}>
              <button className="settings-btn" onClick={() => callGlobal('sendReport')} id="reportBtn">Send Report</button>
              <span id="reportStatus" style={{ fontSize: '10px', color: 'var(--green)' }}></span>
            </div>
          </div>
          ...
          <div className="settings-section">
            ...
            <div className="settings-row" style={{ flexDirection: 'column', alignItems: 'flex-start', gap: '6px' }}>
              ...
              <div style={{ display: 'flex', gap: '8px', width: '100%' }}>
                ...
                <button className="settings-btn" onClick={() => callGlobal('redeemCode')} id="redeemBtn">Redeem</button>
              </div>
              <span id="redeemStatus" style={{ fontSize: '10px', color: 'var(--green)' }}></span>
            </div>
          </div>
          ...
          <div className="settings-section">
            ...
            <div className="settings-row" style={{ flexDirection: 'column', gap: '5px', alignItems: 'flex-start' }}>
              <div style={{ fontSize: '10px', color: 'var(--dim)' }} id="downloadHint">Install NEXUS AI Plugin in Roblox Studio</div>
              <button
          ...
          <div className="settings-section">
            ...
            <div className="settings-row">
              ...
              <button className="settings-btn danger" onClick={() => callGlobal('logout')}>Logout</button>
            </div>
          </div>

          <div className="modal-footer">
            <button className="btn-modal primary" onClick={() => callGlobal('closeModal', 'settingsModal')} id="settingsCloseBtn">CLOSE</button>
          </div>
        </div>
      </div>
      ...
      <div className="ov" id="guiCodeModal">
        <div className="modal" style={{ width: '640px' }}>
          ...
          <div className="modal-footer">
            <button className="btn-modal primary" onClick={() => callGlobal('copyGuiCode')} id="guiCodeCopyBtn">Copy</button>
            <button className="btn-modal secondary" onClick={() => callGlobal('downloadGuiCode')} id="guiCodeDlBtn">Download .lua</button>
            <button className="btn-modal secondary" onClick={() => callGlobal('closeModal', 'guiCodeModal')} id="guiCodeCloseBtn">Close</button>
          </div>
        </div>
      </div>
      ...
      <div className="ov" id="guiAIChatModal">
        <div className="modal" style={{ width: '500px' }}>
          ...
          <div className="modal-footer">
            <button className="btn-modal primary" onClick={() => callGlobal('generateGuiFromAI')} id="guiAiBuildBtn">Build with AI</button>
            <button className="btn-modal secondary" onClick={() => callGlobal('closeModal', 'guiAIChatModal')} id="guiAiCancelBtn">Cancel</button>
          </div>
        </div>
      </div>
      ...
      <div className="ov" id="codePreviewModal">
        <div className="modal" style={{ width: '700px' }}>
          <div className="modal-t">
            ...
            <span style={{ marginLeft: 'auto', fontSize: '9px', color: 'var(--dim)' }} id="codePreviewPath"></span>
          </div>
          <div className="modal-b" style={{ margin: 0 }}>
            <div className="code-block-wrap" style={{ margin: 0, borderRadius: '7px', overflow: 'hidden', border: '1px solid rgba(0,229,255,.15)' }}>
              <div className="code-lang-bar">
                <span>Lua</span>
                <div className="code-btns">
                  <button className="cbtn" onClick={() => callGlobal('copyPreviewCode')}>
                    <svg viewBox="0 0 24 24">
              ...
              <pre style={{ maxHeight: '440px', overflowY: 'auto', margin: 0 }}>
                <code id="codePreviewCode" className="language-lua" style={{ fontSize: '11px', lineHeight: 1.5, padding: '14px', display: 'block' }}></code>
              </pre>
            </div>
          </div>
          <div className="modal-footer" style={{ marginTop: '12px' }}>
            <button className="btn-modal secondary" onClick={() => callGlobal('closeModal', 'codePreviewModal')} id="codePreviewCloseBtn">Close</button>
          </div>
        </div>
      </div>
      ...
      <div className="ov" id="shareModal">
        <div className="modal" style={{ width: '520px' }}>
          ...
          <div className="modal-b" style={{ marginBottom: '8px' }}>
            <p style={{ fontSize: '11px', color: 'var(--dim)', marginBottom: '6px' }} id="shareModalDesc">Copy conversation text:</p>
            <textarea className="share-modal-ta" id="shareModalTa" readOnly></textarea>
          </div>
          <div className="modal-footer">
            <button className="btn-modal primary" onClick={() => callGlobal('copyShareText')} id="shareModalCopyBtn">Copy Text</button>
            <button className="btn-modal secondary" onClick={() => callGlobal('closeModal', 'shareModal')} id="shareModalCloseBtn">Close</button>
          </div>
        </div>
      </div>
    </>
